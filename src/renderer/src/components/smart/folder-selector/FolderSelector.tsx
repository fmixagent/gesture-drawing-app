...
const FolderSelector: React.FC<FolderSelectorProps> = ({ selectedFolder, onFolderSelected }) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        type="button"
        className="flex transition-all ease-in-out duration-200 items-center justify-center border    p-2 rounded-md cursor-pointer bg-gray-900 text-gray-300 hover:bg-gray-700 hover:text-gray-100 border-gray-300/20"
